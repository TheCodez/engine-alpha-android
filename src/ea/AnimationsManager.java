...
public class AnimationsManager extends Manager implements AnimationsEndeReagierbar {
	...
	/**
	 * Animiert ein Raum-Objekt auf einer Strecke aus einer bestimmten Zahl linearer Teilstrecken.<br />
	 * <br />
	 * <br />
	 * <br />
	 * <br />
	 * <br />
	 * Ein <b>Anwendungsbeispiel:</b><br />
	 * <br />
	 * <code>
	 ...
	 * 
	 * @param ziel
	 *            Das zu animierende Raum-Objekt. Sein Zentrum (ueber die Methode <code>zentrum()</code>) wird
	 ...
	 * @param wiederholen
	 *            Gibt an, ob diese Animation in Dauerschleife wiederholt werden soll, oder ob sie nur einmal bis
	 *            zum letzten Punkt sich abspielen soll, und anschliessend sich automatisch selbst beenden soll.
	 * @param geschlossen
	 *            Gibt an, ob <b>bei Wiederholung</b> die Animation vom letzten wieder zum ersten Punkt laufen
	 ...
	 * Die Animation endet nach dem Ablauf ihrer ihr zugesprochenen Dauer (<b>in Millisekunden</b>).<br />
	 * <br />
	 * <b>Ein Beispiel:</b><br />
	 * <br />
	 * <code>
	 ...
	 * - 3000 Millisekunden (= 3 Sekunden) andauert, und dann automatisch beendet wird.<br />
	 * <br />
	 ...
	 * @param dauerInMS
	 *            Die Dauer in Millisekunden, bis die Animation beendet wird. ISt diese geringer als die <code>zielGeschwindigkeit</code>, so erreicht die Animation nicht
